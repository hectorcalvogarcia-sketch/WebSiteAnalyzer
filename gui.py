...
from tkinter import scrolledtext, messagebox, filedialog  # <--- 1. AFEGIM filedialog
import gui_functions as logic
...
boto_guardar = tk.Button(frame_botons, text="Guardar Resultats", command=guardar_txt, bg="#ccffcc")
